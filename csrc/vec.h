...
static void vec2##abbr##_add(vec2##abbr *a, vec2##abbr *b, vec2##abbr *c);	\
static void vec2##abbr##_subtract(vec2##abbr *a, vec2##abbr *b, vec2##abbr *c);	\
static void vec2##abbr##_scale(vec2##abbr *a, vec2##abbr *b, type t);	\
static void vec2##abbr##_normalize(vec2##abbr *a, vec2##abbr *b);	\
static void vec2##abbr##_added(vec2##abbr *a, vec2##abbr *b);	\
static void vec2##abbr##_subtracted(vec2##abbr *a, vec2##abbr *b);	\
static void vec2##abbr##_scaled(vec2##abbr *a, type t);	\
static void vec2##abbr##_normalized(vec2##abbr *a);	\
static type vec2##abbr##_dot(vec2##abbr *a, vec2##abbr *b);	\
static type vec2##abbr##_length_squared(vec2##abbr *a);	\
static type vec2##abbr##_length(vec2##abbr *a);	\
static bool vec2##abbr##_equal(vec2##abbr *a, vec2##abbr *b);	\
static void vec2##abbr##_lerp(vec2##abbr *a, vec2##abbr *b, vec2##abbr *c, float t);	\
static type * vec2##abbr##_ptr(vec2##abbr *a);	\
static vec3##abbr vec2##abbr##_to_vec3##abbr(vec2##abbr *a);	\
static vec4##abbr vec2##abbr##_to_vec4##abbr(vec2##abbr *a);	\
...
static inline void vec2##abbr##_add(vec2##abbr *a, vec2##abbr *b, vec2##abbr *c) {	\
	a->x = b->x + c->x;	\
	a->y = b->y + c->y;	\
}	\
static inline void vec2##abbr##_subtract(vec2##abbr *a, vec2##abbr *b, vec2##abbr *c) {	\
	a->x = b->x - c->x;	\
	a->y = b->y - c->y;	\
}	\
static inline void vec2##abbr##_scale(vec2##abbr *a, vec2##abbr *b, type s) {	\
	a->x = b->x * s;	\
	a->y = b->y * s;	\
}	\
static inline void vec2##abbr##_normalize(vec2##abbr *a, vec2##abbr *b) {	\
	type s = square_root(b->x * b->x + b->y * b->y);	\
	a->x = b->x / s;	\
	a->y = b->y / s;	\
}	\
static inline void vec2##abbr##_added(vec2##abbr *a, vec2##abbr *b) {	\
	vec2##abbr##_add(a, a, b);	\
}	\
static inline void vec2##abbr##_subtracted(vec2##abbr *a, vec2##abbr *b) {	\
...
static inline type vec2##abbr##_dot(vec2##abbr *a, vec2##abbr *b) {	\
	return a->x * b->x + a->y * b->y;	\
}	\
static inline type vec2##abbr##_length_squared(vec2##abbr *a) {	\
	return a->x * a->x + a->y * a-> y;	\
}	\
static inline type vec2##abbr##_length(vec2##abbr *a) {	\
	return square_root(vec2##abbr##_length_squared(a));	\
}	\
static inline bool vec2##abbr##_equal(vec2##abbr *a, vec2##abbr *b) {	\
	return	a->x == b->x &&	\
		a->y == b->y;	\
}	\
static inline void vec2##abbr##_lerp(vec2##abbr *a, vec2##abbr *b, vec2##abbr *c, float t) {	\
	a->x = b->x * (1 - t) + c->x * t;	\
	c->y = b->y * (1 - t) + c->y * t;	\
}	\
...
static inline vec3##abbr vec2##abbr##_to_vec3##abbr(vec2##abbr *a) {	\
	vec3##abbr b;	\
	b.x = a->x;	\
	b.y = a->y;	\
	b.z = 0;	\
...
static inline vec4##abbr vec2##abbr##_to_vec4##abbr(vec2##abbr *a) {	\
	vec4##abbr b;	\
	b.x = a->x;	\
	b.y = a->y;	\
	b.z = 0;	\
...
static void vec3##abbr##_add(vec3##abbr *a, vec3##abbr *b, vec3##abbr *c);	\
static void vec3##abbr##_subtract(vec3##abbr *a, vec3##abbr *b, vec3##abbr *c);	\
static void vec3##abbr##_scale(vec3##abbr *a, vec3##abbr *b, type t);	\
static void vec3##abbr##_cross(vec3##abbr *a, vec3##abbr *b, vec3##abbr *c);	\
static void vec3##abbr##_normalize(vec3##abbr *a, vec3##abbr *b);	\
static void vec3##abbr##_added(vec3##abbr *a, vec3##abbr *b);	\
static void vec3##abbr##_subtracted(vec3##abbr *a, vec3##abbr *b);	\
static void vec3##abbr##_scaled(vec3##abbr *a, type t);	\
static void vec3##abbr##_crossed(vec3##abbr *a, vec3##abbr *b);	\
static void vec3##abbr##_normalized(vec3##abbr *a);	\
static type vec3##abbr##_dot(vec3##abbr *a, vec3##abbr *b);	\
static bool vec3##abbr##_equal(vec3##abbr *a, vec3##abbr *b);	\
static void vec3##abbr##_lerp(vec3##abbr *a, vec3##abbr *b, vec3##abbr *c, float t);	\
static type * vec3##abbr##_ptr(vec3##abbr *a);	\
static vec2##abbr vec3##abbr##_to_vec2##abbr(vec3##abbr *a);	\
static vec4##abbr vec3##abbr##_to_vec4##abbr(vec3##abbr *a);	\
...
static inline void vec3##abbr##_add(vec3##abbr *a, vec3##abbr *b, vec3##abbr *c) {	\
	a->x = b->x + c->x;	\
	a->y = b->y + c->y;	\
	a->z = b->z + c->z;	\
}	\
static inline void vec3##abbr##_subtract(vec3##abbr *a, vec3##abbr *b, vec3##abbr *c) {	\
	a->x = b->x - c->x;	\
	a->y = b->y - c->y;	\
	a->z = b->z - c->z;	\
}	\
static inline void vec3##abbr##_scale(vec3##abbr *a, vec3##abbr *b, type s) {	\
	a->x = b->x * s;	\
	a->y = b->y * s;	\
	a->z = b->z * s;	\
}	\
static inline void vec3##abbr##_cross(vec3##abbr *a, vec3##abbr *b, vec3##abbr *c) {	\
	a->x = b->y * c->z - b->z * c->y;	\
	a->y = b->z * c->x - b->x * c->z;	\
	a->z = b->x * c->y - b->y * c->x;	\
}	\
static inline void vec3##abbr##_normalize(vec3##abbr *a, vec3##abbr *b) {	\
	type s = square_root(a->x * a->x + a->y * a->y + a->z * a->z);	\
	a->x = b->x / s;	\
	a->y = b->y / s;	\
	a->z = b->z / s;	\
}	\
static inline void vec3##abbr##_added(vec3##abbr *a, vec3##abbr *b) {	\
	vec3##abbr##_add(a, a, b);	\
}	\
static inline void vec3##abbr##_subtracted(vec3##abbr *a, vec3##abbr *b) {	\
	vec3##abbr##_subtract(a, a, b);	\
}	\
static inline void vec3##abbr##_scaled(vec3##abbr *a, type s) {	\
	vec3##abbr##_scale(a, a, s);	\
}	\
static inline void vec3##abbr##_crossed(vec3##abbr *a, vec3##abbr *b) {	\
	vec3##abbr##_cross(a, a, b);	\
}	\
static inline void vec3##abbr##_normalized(vec3##abbr *a) {	\
	vec3##abbr##_normalize(a, a);	\
}	\
static inline type vec3##abbr##_dot(vec3##abbr *a, vec3##abbr *b) {	\
	return a->x * b->x + a->y * b->y + a->z * b->z;	\
}	\
static inline bool vec3##abbr##_equal(vec3##abbr *a, vec3##abbr *b) {	\
	return	a->x == b->x &&	\
		a->y == b->y &&	\
		a->z == b->z;	\
}	\
static inline void vec3##abbr##_lerp(vec3##abbr *a, vec3##abbr *b, vec3##abbr *c, float t) {	\
	a->x = b->x * (1 - t) + c->x * t;	\
	a->y = b->y * (1 - t) + c->y * t;	\
	a->z = b->z * (1 - t) + c->z * t;	\
}	\
...
static inline vec2##abbr vec3##abbr##_to_vec2##abbr(vec3##abbr *a) {	\
	vec2##abbr b;	\
	b.x = a->x;	\
	b.y = a->y;	\
	return b;	\
}	\
static inline vec4##abbr vec3##abbr##_to_vec4##abbr(vec3##abbr *a) {	\
	vec4##abbr b;	\
	b.x = a->x;	\
	b.y = a->y;	\
	b.z = a->z;	\
...
DEFINE_VECX(f, float, sqrtf)
DEFINE_VECX(i, int, sqrtf)
DEFINE_VECX(d, double, sqrt)
